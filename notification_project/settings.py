...
SECRET_KEY = 'django-insecure-txt#eqa%v*lgf@b#f*u@!zmqal7=2orxke7rg72!h$ff_rsghc'
...
INSTALLED_APPS = [
    ...
    'blog', # We will create this app next
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            # 'builtins': ['django.urls.templatetags.url'],  # Removed invalid builtins entry
        },
    },
]
...
STATIC_URL = '/static/' # Check if this path is correct
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'staticfiles'),
]

# Need to add static root when application goes to production
